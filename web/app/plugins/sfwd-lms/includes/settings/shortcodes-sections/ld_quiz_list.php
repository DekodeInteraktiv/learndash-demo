	...
	class LearnDash_Shortcodes_Section_ld_quiz_list extends LearnDash_Shortcodes_Section {
		...
		public function __construct( $fields_args = array() ) {
			...
			$this->shortcodes_section_description = sprintf(
				...
				LearnDash_Custom_Label::label_to_lower( 'quizzes' ), LearnDash_Settings_Section::get_section_setting( 'LearnDash_Settings_Section_Permalinks', 'quizzes' )
			);
		...
		public function init_shortcodes_section_fields() {
			...
			if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Quizzes_Taxonomies', 'ld_quiz_category' ) == 'yes') {
				$this->shortcodes_option_fields['quiz_cat'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned category id.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
					'class'			=>	'small-text'
				);
				...
				$this->shortcodes_option_fields['quiz_category_name'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned category slug.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
				);
				...
				$this->shortcodes_option_fields['quiz_categoryselector'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows a %s category dropdown.', 'placeholders: quiz', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ),
					'value' 		=> 	'',
					'options'		=>	array(
			...
			if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Quizzes_Taxonomies', 'ld_quiz_tag' ) == 'yes') {
				$this->shortcodes_option_fields['quiz_tag_id'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned tag id.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
					'class'			=>	'small-text'
				);
				...
				$this->shortcodes_option_fields['quiz_tag'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned tag slug.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
				);
			}
			...
			if ( LearnDash_Settings_Section::get_section_setting( 'LearnDash_Settings_Quizzes_Taxonomies', 'wp_post_category' ) == 'yes' ) {
				$this->shortcodes_option_fields['cat'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned WP category id.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
					'class'			=>	'small-text'
				);
				...
				$this->shortcodes_option_fields['category_name'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned WP category slug.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
				);
			...
			if ( LearnDash_Settings_Section::get_section_setting('LearnDash_Settings_Quizzes_Taxonomies', 'wp_post_tag' ) == 'yes') {
				$this->shortcodes_option_fields['tag'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned WP tag slug.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
				);
				...
				$this->shortcodes_option_fields['tag_id'] = array(
					...
					'help_text'		=>	sprintf( esc_html_x( 'shows %s with mentioned WP tag id.', 'placeholders: quizzes', 'learndash' ), LearnDash_Custom_Label::label_to_lower( 'quizzes' ) ),
					'value' 		=> 	'',
					'class'			=>	'small-text'
				);
			}
